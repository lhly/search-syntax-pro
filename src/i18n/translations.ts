...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'options.fields.autoOpen.label': '自动在新标签页打开搜索结果',
    'options.fields.autoOpen.description': '执行搜索时自动在新标签页打开结果页面',
    ...
    'options.confirm.reset': '确定要重置所有设置吗？这将清除所有自定义配置。',
  ...
  'en-US': {
    ...
    'options.fields.autoOpen.label': 'Open results in a new tab automatically',
    'options.fields.autoOpen.description': 'Open the search results in a new tab when executing a search.',
    ...
    'options.confirm.reset': 'Reset all settings? This will remove your custom configuration.',
